...
class EpicTest {
    ...
    public void shouldHaveStatusNewWithAllNewSubtasks() {
        Epic epic = new Epic("test epic", "epic desc");
        Subtask subtask1 = new Subtask("subtask 1", "subtask desc", Status.NEW, 1);
        Subtask subtask2 = new Subtask("subtask 2", "subtask desc", Status.NEW, 1);
    ...
    public void shouldHaveStatusDoneWithAllDoneSubtasks() {
        Epic epic = new Epic("test epic", "epic desc");
        Subtask subtask1 = new Subtask("subtask 1", "subtask desc", Status.DONE, 1);
        Subtask subtask2 = new Subtask("subtask 2", "subtask desc", Status.DONE, 1);
        epic.addSubtask(subtask1);
        epic.addSubtask(subtask2);
    ...
    public void shouldUpdateStatusWhenSubtasksAreRemoved() {
        Epic epic = new Epic("test epic", "epic desc");
        Subtask subtask1 = new Subtask(2,"subtask 1", "subtask desc", Status.DONE, 1);
        Subtask subtask2 = new Subtask(3,"subtask 2", "subtask desc", Status.NEW, 1);
        epic.addSubtask(subtask1);
        epic.addSubtask(subtask2);
        assertEquals(Status.IN_PROGRESS, epic.getStatus(), "Эпик с подзадачами в разных статусах должен иметь статус IN_PROGRESS");
